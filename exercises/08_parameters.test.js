...
test('08_parameters-6: is an actual array, unlike arguments', () => {
  ...
  /*
  args creates a true array, which can be directly used with array methods ( map , filter , reduce , etc.). The arguments object is array-like but not a true array, so it lacks built-in array methods.
  */
  ...
  expect(typeof rests.splice).toBe('function')
})
